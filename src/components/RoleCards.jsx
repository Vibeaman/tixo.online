...
const roles = [
  {
    ...
    gradient: 'linear-gradient(135deg, rgba(123,78,247,0.2), rgba(157,122,250,0.05))',
  },
  {
    ...
    gradient: 'linear-gradient(135deg, rgba(147,51,234,0.2), rgba(123,78,247,0.05))',
  },
  {
    ...
    gradient: 'linear-gradient(135deg, rgba(168,85,247,0.2), rgba(123,78,247,0.05))',
  },
  {
    num: '04', badge: 'VENDOR',
    ...
    gradient: 'linear-gradient(135deg, rgba(139,92,246,0.2), rgba(123,78,247,0.05))',
  },
]
...
function RoleCard({ r, i }) {
  ...
  return (
    <ScrollReveal direction={i % 2 === 0 ? 'left' : 'right'} delay={0.15 + i * 0.12} rotate={i % 2 === 0 ? -2 : 2}>
      <Tilt3D intensity={22} glowColor="rgba(123,78,247,0.25)">
        <div
        ...
        >
          ...
          <div style={{
            ...
            background: 'rgba(123,78,247,0.1)',
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <div style={{
              width: 48, height: 48,
              background: hovered ? 'rgba(123,78,247,0.3)' : 'rgba(123,78,247,0.12)',
              borderRadius: 14,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              marginBottom: 16,
              transition: 'all 0.4s cubic-bezier(0.23,1,0.32,1)',
              transform: hovered ? 'rotate(-12deg) scale(1.15) translateY(-4px)' : 'rotate(0) scale(1)',
              boxShadow: hovered ? '0 8px 25px rgba(123,78,247,0.3)' : 'none',
            }}>
            ...
            <div style={{
              borderTop: '2px dashed rgba(123,78,247,0.2)', margin: '12px 0', width: '100%',
              transition: 'border-color 0.3s',
              borderColor: hovered ? 'rgba(123,78,247,0.4)' : 'rgba(123,78,247,0.2)',
            }} />
  ...
  return (
    <section style={{ padding: 'clamp(60px, 8vw, 100px) 24px', background: 'var(--lavender)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: '10%', right: '-5%', opacity: 0.5 }}>
        <MorphBlob size={300} color="rgba(123,78,247,0.06)" />
      </div>

      <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 1 }}>
        {/* Vision card */}
        <ScrollReveal direction="up" delay={0.1} distance={50}>
          <Tilt3D intensity={8} glowColor="rgba(123,78,247,0.15)">
            <div style={{
              background: 'var(--dark)',
              borderRadius: 20,
