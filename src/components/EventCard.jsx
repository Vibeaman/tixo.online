...
export default function EventCard({ event }) {
  ...
  return (
    <div
      ...
      onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.borderColor = 'rgba(123,78,247,0.35)'; e.currentTarget.style.boxShadow = '0 12px 40px rgba(123,78,247,0.12)' }}
      onMouseLeave={e => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.borderColor = 'rgba(123,78,247,0.12)'; e.currentTarget.style.boxShadow = 'none' }}
    >
      {/* Image */}
      ...
      <div style={{ padding: '16px 18px 18px' }}>
        ...
        <div style={{ marginTop: 16, display: 'flex', justifyContent: 'flex-end' }}>
          <span className="btn btn-purple" style={{ fontSize: '0.68rem' }}>
